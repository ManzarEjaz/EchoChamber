...
export default function EchoChamberPage() {
  ...
  const handleTemplateButtonClick = (templateText: string) => {
    setError("");
    setOutputText("");
    setInputText(templateText); // For display and if user modifies then hits Echo Text
    ...
    // Template text is assumed to be valid (not empty)
  ...
  const handleMuwahPlus = () => {
    ...
    if (!muwahPlusEmoji.trim()) {
      setError("Please enter an emoji for Muwah+.");
      return;
    }
    ...
    setInputText(`✨ Generated by Muwah+ (${muwahPlusEmoji}) ✨`); 
    setOutputText(muwahText);
    toast({
        title: "Muwah+ Generated!",
        description: `Created ${currentRepeatCount} expanding Muwahs with ${muwahPlusEmoji}.`,
        duration: 3000,
      });
  };
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  aria-label="Emoji for Muwah+ generator (e.g., 💗, ❤️)"
                />
                <Button 
                  ...
                  aria-label="Generate increasing Muwahs with custom emoji"
                >
